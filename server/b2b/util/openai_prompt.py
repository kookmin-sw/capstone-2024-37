class Template:
    ...
    When responding to user input, it is important to adjust the response to the specified output language while maintaining a consistent and accessible style of communication. To respond to user input, Korean must be used. Not only must your responses be accurate, but they must also show empathy and understanding for your needs.
